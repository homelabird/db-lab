...
Cerebro의 내부 ES 연결 주소는 여전히 `http://es01:9200`입니다. 호스트에 공개하는 포트와 컨테이너 네트워크 내부 포트는 다릅니다. 새 프로젝트는 기존 랩의 볼륨을 자동 재사용하지 않습니다. 옛 인덱스를 유지한 채 새 시드만 넣는 마이그레이션 도구가 아닙니다.
